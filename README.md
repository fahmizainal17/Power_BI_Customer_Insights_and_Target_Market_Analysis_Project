...
5. [🧠 Key Concepts and Methodology](#-key-concepts-and-methodology)
6. [📈 Analysis and Findings](#-analysis-and-findings)
7. [💡 Recommendations](#-recommendations)
8. [⚠️ Limitations and Proposals for Improvement](#-limitations-and-proposals-for-improvement)
...
- **🔍 Identify key customer segments** based on demographics, viewing preferences, and purchasing behaviors.
- **📈 Provide actionable insights** to guide marketing strategies and enhance customer engagement.
- **🛠️ Utilize advanced Power BI features** for data visualization, including DAX calculations and interactive dashboards.
...
- **Segmentation:** Using Power BI’s slicers and filters to analyze data by demographics and transaction status.
...
### **Target Market Dashboard**

1. **Metrics Target:**
   - **Body Type Preference:** SUVs lead in popularity, especially for Brand B.
   - **Brand Pricing:** Higher average prices for Brand B’s SUVs indicate a premium market segment.
...
2. **Promote SUVs:**
   - Highlight SUV models, especially from Brand B, to capitalize on the segment’s higher interest and pricing.
...
## **⚠️ Limitations and Proposals for Improvement**
...
- **Lack of Real-Time Data:** The analysis doesn’t consider dynamic factors like real-time pricing changes or promotional impacts.
